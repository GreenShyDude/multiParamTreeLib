 ...
 */ 
mpt::doubleNode::doubleNode(int p1, std::string p2) :
  param1(p1),
  param2(p2),
  left1(nullptr),
  left2(nullptr),
 ...
 */ 
bool mpt::doubleNode::addNode(doubleNode *target){
  if (!target) {
    return false;
  }
 ...
 */
bool mpt::doubleNode::addNodeP1(doubleNode* cursor,  doubleNode *target) {
...
bool mpt::doubleNode::addNodeP2(doubleNode* cursor, doubleNode *target) {
 ...
 * Private 
 */
bool mpt::doubleNode::addPeerP1(doubleNode * cursor, doubleNode * target) {
...
bool mpt::doubleNode::addPeerP2(doubleNode * cursor, doubleNode * target) {    
...
void mpt::doubleNode::removeNodeP1(doubleNode* cursor, doubleNode * target) {
...
void mpt::doubleNode::printTreeP1() {
...
void mpt::doubleNode::printTreeP2() {
...
void mpt::doubleNode::printPeerP1(doubleNode *Node) {
  if (!Node) return;
  printPeerP1(Node->peer1l);
  std::cout << Node->param2 << "-";
  printPeerP1(Node->peer1r);
} 
void mpt::doubleNode::printPeerP2(doubleNode *Node) {
  if (!Node) return;
...
void mpt::doubleNode::printNoodeP1(doubleNode *Node) {
  if (!Node) return;
...
void mpt::doubleNode::printNoodeP2(doubleNode *Node) {
  if (!Node) return;
